Public Class ExamMarksScreen
    ...
    Public Sub LoadData(PropertyName As String) Implements IBaseScreen.LoadData
        ...
        Dim q_cwmarks = From cwm In DBContext.MarksExamCWs.Include("Student")
        ...
        Dim q_cenr = From cenr In DBContext.CourseEnrollments.Include("Student")
    ...
    Public Sub SaveDataColumnsToEntities(ExtractedData As Dictionary(Of String, List(Of String))) Implements IBaseScreen.SaveDataColumnsToEntities
        ...
        For i As Integer = 0 To indexList.Count - 1
            ...
            If ExtractedData("Exam Marks") IsNot Nothing Then
                exmark.ExamMark = ExtractedData("Exam Marks")(i)
            End If
        Next

        ExamMarksDataGrid.Items.Refresh()
    End Sub
End Class
